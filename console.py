...
=======
"""Defines the HBnB console."""
>>>>>>> ef26754 (Implemented console.py with command interpreter functionality, custom prompt, quit, EOF, and help commands. This completes Task 7: Add Place and State models, and updates commands for create, show, destroy, all, count, and update. Console 0.1.)
import cmd
import re
from shlex import split
from models import storage
